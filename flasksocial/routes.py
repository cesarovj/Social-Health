...
from flasksocial import app, db, bcrypt
from flasksocial.forms import Registration, Login, UpdateAccount, PostForm
from flasksocial.models import User, Post, Comment
...
def post(post_id):
    ...
    if request.method == "POST":
        ...
        comment = Comment(message=message, post_id=post.id)
        db.session.add(comment)
        flash("Comment was submitted.", "success")
        db.session.commit()
        return redirect(url_for("home"))
